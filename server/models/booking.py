...
class Booking(Base):
    ...
    def to_dict(self):
        return {
            ...
            "scheduled_start_time": str(self.scheduled_start_time) if self.scheduled_start_time else None,
            "scheduled_end_time": str(self.scheduled_end_time) if self.scheduled_end_time else None,
